...
public class EveningEvent implements Parcelable{
	...
	public EveningEvent(int id, String status, String logo, String time,
	...
	public static final Parcelable.Creator<EveningEvent> CREATOR = new Parcelable.Creator<EveningEvent>() {
		public EveningEvent createFromParcel(Parcel in) {
			return new EveningEvent(in);
		}

		public EveningEvent[] newArray(int size) {
			return new EveningEvent[size];
		}
	};

	private EveningEvent(Parcel in) {
