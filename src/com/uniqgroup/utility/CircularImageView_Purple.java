...
public class CircularImageView_Purple extends ImageView
{
	...
	public CircularImageView_Purple(Context context)
	{
		this(context, null);
	}

	public CircularImageView_Purple(Context context, AttributeSet attrs)
	{
		this(context, attrs, R.attr.circularImageViewStyle);
	}

	public CircularImageView_Purple(Context context, AttributeSet attrs, int defStyle)
	{
	...
	private void init(Context context, AttributeSet attrs, int defStyle)
	{
		...
		if(hasBorder) {
			...
			setBorderWidth(20);
			setBorderColor(attributes.getColor(R.styleable.CircularImageView_border_color, R.color.purplee));
		}
	...
	{
		if (paintBorder != null)
			paintBorder.setColor(Color.parseColor("#ff82358b"));
		this.invalidate();
	}
