...
public class DayEventMorningListAdapter extends BaseAdapter {
	ArrayList<MorningEvent> DataList;
	Context ctx;
	...
	public DayEventMorningListAdapter(Context context,
			ArrayList<MorningEvent> list) {
	...
	public void changeData(ArrayList<MorningEvent> newList) {
		DataList = newList;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.action_IV.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) 
			{
				...
				uela.checkSelectedActivity(iv, event_id, event_tts, 0, position, 1);
			}
		});
		...
		holder.action_IV.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View v) 
			{
				ImageView iv = (ImageView) v;
				UserEventListActivity uela = (UserEventListActivity) ctx;
				uela.checkSelectedActivity(iv, event_id, event_tts, 1,position, 1);
				return true;
			}
		});
		...
		// .getDrawable(R.drawable.ic_tick_disbled).getConstantState()) {
		//
		...
		/*if (uela.checkMorningList(position)) {
